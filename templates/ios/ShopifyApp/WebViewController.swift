...
class WebViewController: UIViewController {
    ...
    private let storeURL = "{{STORE_URL}}"
    ...
    private func setupProgressView() {
        ...
        progressView.progressTintColor = UIColor(hex: "{{THEME_COLOR}}")
    ...
    private func setupRefreshControl() {
        ...
        refreshControl.tintColor = UIColor(hex: "{{THEME_COLOR}}")
    ...
    private func setupOfflineView() {
        ...
        retryButton.backgroundColor = UIColor(hex: "{{THEME_COLOR}}")

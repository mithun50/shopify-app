    ...
    private void setupWebView() {
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                // Fallback for WebView < 102 (Android < 12) where DOCUMENT_START_SCRIPT
                // is not supported. onPageFinished runs in the new page's context (unlike
                // onPageStarted which runs in the OLD page's context). This installs the
                // bridge on the app page before the user taps "Sign in" — so Firebase's
                // sessionStorage.setItem call is captured and saved to SharedPreferences.
